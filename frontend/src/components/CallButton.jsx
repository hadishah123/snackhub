...
function CallButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-6 flex items-center gap-2 bg-blue-600 hover:bg-blue-700 hover:scale-105 text-white px-4 py-3 rounded-full shadow-lg z-50 transition-all"
    >
      {/* Mobile text */}
